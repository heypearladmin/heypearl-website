      ...
      <Container size="lg">
        ...
        <div className="mb-16 max-w-2xl">
          ...
          >
            ...
            <span style={{ color: '#FF6A00', fontStyle: 'italic' }}>The Authority Era has begun.</span>
          </h2>
        ...
        >
          <p style={{ fontSize: '0.9rem', color: '#64748B', lineHeight: 1.6 }}>
            <span style={{ color: '#0A1224', fontWeight: 600 }}>The shift is not coming.</span>{' '}
          ...
          <p style={{ fontSize: '0.82rem', color: '#FF6A00', whiteSpace: 'nowrap', flexShrink: 0 }}>
            Keep reading ↓
          </p>
        </div>
      </Container>
