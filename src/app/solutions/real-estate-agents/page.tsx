      ...
      >
        ...
        <Container size="lg" className="relative z-10 pt-40 sm:pt-48 pb-20">
          ...
          <h1 className="max-w-3xl" style={{ fontFamily: 'var(--font-playfair), Georgia, serif', fontSize: 'clamp(2.6rem, 6vw, 5rem)', fontWeight: 700, color: '#F2EDE4', lineHeight: 1.04, letterSpacing: '-0.03em' }}>
            ...
            <span style={{ color: '#BF9B5C', fontStyle: 'italic' }}>who to call.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-playfair), Georgia, serif', fontSize: 'clamp(1.9rem, 4vw, 2.8rem)', fontWeight: 700, color: '#F2EDE4', lineHeight: 1.1, letterSpacing: '-0.022em', marginBottom: '1.25rem' }}>
                ...
                <span style={{ color: '#BF9B5C', fontStyle: 'italic' }}>you the authority AI trusts.</span>
              </h2>
      ...
      <section className="py-24 bg-[#0A0A0A]">
        <Container size="lg">
          <div className="mb-12 max-w-2xl">
            <div className="flex items-center gap-3 mb-5">
              <span className="inline-block h-px w-8" style={{ background: 'rgba(191,155,92,0.4)' }} aria-hidden />
              <span style={{ fontSize: '0.67rem', fontWeight: 600, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#BF9B5C' }}>What You Get</span>
            </div>
            <h2 style={{ fontFamily: 'var(--font-playfair), Georgia, serif', fontSize: 'clamp(1.9rem, 4vw, 3rem)', fontWeight: 700, color: '#F2EDE4', lineHeight: 1.08, letterSpacing: '-0.022em' }}>
              Authority that compounds.<br />
              <span style={{ color: '#BF9B5C', fontStyle: 'italic' }}>Not ads that expire.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-px"
            style={{ border: '1px solid rgba(255,255,255,0.05)', borderRadius: '1rem', overflow: 'hidden' }}>
            {OUTCOMES.map((o, i) => (
              <div key={i} className="p-8 text-center" style={{ background: i % 2 === 0 ? '#0D0D0D' : '#0F0F0F' }}>
                <div style={{ fontFamily: 'var(--font-playfair), Georgia, serif', fontSize: '2.5rem', fontWeight: 700, color: '#BF9B5C', lineHeight: 1, marginBottom: '0.75rem' }}>{o.metric}</div>
                <p style={{ fontSize: '0.875rem', color: 'rgba(242,237,228,0.5)', lineHeight: 1.6 }}>{o.label}</p>
              </div>
            ))}
          </div>

          <div className="mt-8 p-6 rounded-xl" style={{ background: 'rgba(191,155,92,0.04)', border: '1px solid rgba(191,155,92,0.1)' }}>
            <p style={{ fontSize: '0.875rem', color: 'rgba(242,237,228,0.5)', lineHeight: 1.7, fontStyle: 'italic' }}>
            ...
            <p className="mt-3" style={{ fontSize: '0.75rem', color: 'rgba(242,237,228,0.3)' }}>Client details anonymized. Results represent real engagements — outcomes vary by market and engagement scope.</p>
          </div>
        </Container>
      </section>
