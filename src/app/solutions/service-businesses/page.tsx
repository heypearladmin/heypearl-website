...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.heypearl.io/solutions/service-businesses' },
  openGraph: {
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Service Businesses', item: `${site.url}/solutions/service-businesses` },
  ],
};
    ...
    <>
      ...
      >
        ...
        <div aria-hidden className="pointer-events-none absolute top-0 left-0 w-[600px] h-[500px]"
          style={{ background: 'radial-gradient(ellipse at top left, rgba(255,106,0,0.04) 0%, transparent 65%)' }} />
        <Container size="lg" className="relative z-10 pt-40 sm:pt-48 pb-20">
          <div className="flex items-center gap-2 mb-6 flex-wrap">
            ...
            <span style={{ fontSize: '0.72rem', color: '#FF6A00', fontWeight: 600 }}>Service Businesses</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-jakarta), Helvetica Neue, Arial, sans-serif', fontSize: 'clamp(1.9rem, 4vw, 2.8rem)', fontWeight: 700, color: '#0A1224', lineHeight: 1.1, letterSpacing: '-0.022em', marginBottom: '1.25rem' }}>
                ...
                <span style={{ color: '#FF6A00', fontStyle: 'italic' }}>for your service category.</span>
              </h2>
      ...
      <section className="py-12 bg-white">
        <Container size="lg">
          ...
          >
            <div>
              <div style={{ fontSize: '0.63rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#FF6A00', marginBottom: '0.35rem' }}>
                Related Playbook
              </div>
              <div style={{ fontSize: '0.95rem', fontWeight: 600, color: '#0A1224' }}>
                AI Visibility for Local Service Businesses: The Complete Playbook
              </div>
            </div>
            <ArrowUpRight size={16} style={{ color: '#FF6A00' }} />
          </Link>
        </Container>
      </section>
      ...
      <section className="py-24 bg-[#0A1224]">
        <Container size="md" className="text-center">
          ...
          <h2 className="mb-5 max-w-xl mx-auto" style={{ fontFamily: 'var(--font-jakarta), Helvetica Neue, Arial, sans-serif', fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', fontWeight: 700, color: '#FFFFFF', lineHeight: 1.1, letterSpacing: '-0.022em' }}>
            ...
            <span style={{ color: '#FF6A00', fontStyle: 'italic' }}>in AI search.</span>
          </h2>
