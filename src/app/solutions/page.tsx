...
export const metadata: Metadata = {
  title: 'Solutions — HeyPearl for Your Business',
  description:
  ...
  alternates: { canonical: 'https://www.heypearl.io/solutions' },
  openGraph: {
...
export default function SolutionsPage() {
  return (
    <>
      {/* Hero */}
      <section
        className="relative -mt-24 sm:-mt-28 min-h-[62vh] flex flex-col justify-center bg-white overflow-hidden"
      ...
      <section className="py-28 bg-white">
        <Container size="lg">
          ...
          <div className="space-y-px" style={{ border: '1px solid #E7E3DD', borderRadius: '1rem', overflow: 'hidden', boxShadow: cardShadow }}>
            {SOLUTIONS.map((sol, i) => (
              <Reveal key={sol.href} delay={i * 0.07}>
              <Link href={sol.href}
                className="group flex flex-col sm:flex-row sm:items-center gap-5 p-7 lg:p-8 hover:bg-[#F8F5F0] transition-colors duration-200"
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <div style={{ fontSize: '0.63rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#94A3B8', marginBottom: '0.3rem' }}>The problem</div>
                    <p style={{ fontSize: '0.85rem', color: '#334155', lineHeight: 1.6 }}>{sol.problem}</p>
                  </div>
                  <div>
                    <div style={{ fontSize: '0.63rem', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#64748B', marginBottom: '0.3rem' }}>The outcome</div>
