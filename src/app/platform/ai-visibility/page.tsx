    ...
    <>
      ...
      <section className="py-20 bg-[#F8F5F0]">
        <Container size="lg">
          ...
          <p className="text-center mt-5" style={{ fontSize: '0.8rem', color: '#64748B', lineHeight: 1.6 }}>
        ...
        <Container size="lg">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p style={{ fontSize: '0.95rem', color: '#64748B', lineHeight: 1.8, marginBottom: '1rem' }}>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex gap-3 p-5 rounded-xl" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid #E7E3DD' }}>
