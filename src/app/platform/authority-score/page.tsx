...
import { AuthorityScoreMockup } from '@/components/platform/AuthorityScoreMockup';
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.heypearl.io/platform/authority-score' },
  openGraph: {
