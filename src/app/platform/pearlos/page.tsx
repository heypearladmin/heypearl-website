    ...
    <>
      ...
      >
        ...
        <Container size="lg" className="relative z-10 pt-40 sm:pt-48 pb-20">
          ...
          >
            The operating system for AI authority.
          </p>
          <p className="mt-5 max-w-[36rem]" style={{ fontSize: '1rem', color: 'rgba(242,237,228,0.55)', lineHeight: 1.75 }}>
            PearlOS is the unified intelligence layer that runs every HeyPearl engagement — orchestrating entity signals, monitoring six AI engines in real time, and executing the P.E.A.R.L. framework in the exact sequence required to build compounding AI authority.
          </p>
      ...
      <section className="py-28 bg-[#0A0A0A]">
        <Container size="lg">
          <div className="mb-14 max-w-2xl">
            ...
            >
              The engine beneath<br />
              <span style={{ color: '#BF9B5C', fontStyle: 'italic' }}>every module.</span>
            </h2>
