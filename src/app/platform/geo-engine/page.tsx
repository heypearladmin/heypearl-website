    ...
    <>
      ...
      >
        <div aria-hidden className="pointer-events-none absolute right-8 xl:right-16 top-1/2 -translate-y-1/2 w-[38%] hidden lg:block" style={{ zIndex: 1 }}>
          <div style={{ aspectRatio: '16/10', position: 'relative', borderRadius: '1rem', overflow: 'hidden', border: '1px solid rgba(182,146,94,0.15)', boxShadow: '0 32px 64px rgba(30,58,102,0.7)' }}>
        ...
        <Container size="lg" className="relative z-10 pt-40 sm:pt-48 pb-20">
          ...
          <div className="flex items-center gap-2 mb-6 flex-wrap">
            <Link href="/platform" className="text-xs" style={{ color: '#64748B' }}>Platform</Link>
      ...
      <section className="py-24 bg-[#F8F5F0]">
        <Container size="lg">
          ...
          <div style={{ border: '1px solid #E7E3DD', borderRadius: '1rem', overflow: 'hidden' }}>
            <div className="grid grid-cols-3 gap-px" style={{ background: 'rgba(48,72,111,0.35)' }}>
              ...
              <div className="p-4 text-xs font-semibold" style={{ background: '#FFFFFF', color: '#C2185B', textTransform: 'uppercase', letterSpacing: '0.08em' }}>GEO Engine</div>
            </div>
            {GEO_VS_SEO.map((row, i) => (
              <div key={row.dimension} className="grid grid-cols-3 gap-px" style={{ background: 'rgba(48,72,111,0.35)' }}>
                ...
                <div className="p-4" style={{ background: '#F8F5F0', fontSize: '0.82rem', color: 'rgba(245,241,232,0.75)' }}>{row.geo}</div>
              </div>
            ))}
          </div>
        </Container>
      ...
      <section className="py-24 bg-white">
        <Container size="md" className="text-center">
          ...
          <p className="mb-8 max-w-md mx-auto" style={{ fontSize: '0.95rem', color: '#64748B', lineHeight: 1.75 }}>
