...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.heypearl.io/faq' },
  openGraph: {
    title: 'FAQ — AI Authority Questions Answered | HeyPearl',
    description:
          ...
          <Container size="lg">
            <div className="max-w-3xl">
              ...
              >
                ...
                <span style={{ color: mutedGold, fontStyle: 'italic' }}>AI Authority — answered.</span>
              </h1>
        ...
        <section style={{ paddingTop: '4rem', paddingBottom: '6rem' }}>
          <Container size="lg">
            <div className="space-y-12">
              {groups.map((group, i) => (
                <Reveal key={group.postSlug} delay={i * 0.06}>
                <div>
                  {/* Group header */}
                  ...
                  <div style={{ border: `1px solid ${border}`, borderRadius: '0.875rem', overflow: 'hidden', background: card }}>
                    {group.items.map((item, i) => (
                      <Link
                        key={item.slug}
                        href={`/faq/${item.slug}`}
                        className="group flex items-start justify-between gap-6 p-6 hover:bg-[#EEE9DF] transition-colors duration-150"
